    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--bg)", padding: "1rem" }}>
      <div style={{ width: "100%", maxWidth: "360px" }}>
        ...
        <div className="genia-card" style={{ padding: "2rem" }}>
          <h1 style={{ fontSize: "1.1rem", fontWeight: 700, marginBottom: "1.25rem" }}>Mot de passe</h1>
          {error && (
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            <input className="genia-input" type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••" required autoFocus />
